...
export class Player extends GameObject {
  ...
  tryMove(delta, root) {
    ...
    if (input.key) {
      if (input.key === 'F1' && this.currentWorld != 'world') {
        this.teleport(-128, 96, 'world');
      }
      if (input.key === 'F2' && this.currentWorld != 'brewhouse') {
    ...
    const collisionCheck = isSpaceFree(nextX, nextY, this.currentWorld, this);
