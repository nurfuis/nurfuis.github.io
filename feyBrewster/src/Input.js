...
;
    ...
    document.addEventListener("mousedown", (e) => {
      ...
      // find how much offset the stage is translated by from camera
      ...
      const tilesAcross = stageWidth / tileSize;
      const tilesDown = stageHeight / tileSize;
      ...
      const scale = windowX / stageWidth;    
      const windowY = stageHeight * scale;
